...
<small>Note: Authors are ordered alphabetically in theoretical computer science.</small>

1. **[On Cutting Cakes and Crossing Curves](https://arxiv.org/abs/2606.13980)**  
   _with Alexandros Hollender and Kilian Risse_  
   To appear at the 27th Conference on Economics and Computation (EC) 2026

2. **[Generalised Linial-Nisan Conjecture is False for DNFs](https://eccc.weizmann.ac.il/report/2025/058/)**  
   _with Yaroslav Alekseev, Mika Göös, Ziyi Guan, Artur Riazanov, Dmitry Sokolov and Weiqiang Yuan_  
   [Conference version](https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.CCC.2025.29): Computational Complexity Conference (CCC) 2025

3. **[Direct Sums for Parity Decision Trees](https://arxiv.org/abs/2412.06552)**  
   _with Tyler Besselman, Mika Göös, Siyao Guo and Weiqiang Yuan_  
   [Conference version](https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.CCC.2025.16): Computational Complexity Conference (CCC) 2025

4. **[Supercritical Tradeoffs for Monotone Circuits](https://arxiv.org/abs/2411.14268)**  
   _with Mika Göös, Kilian Risse and Dmitry Sokolov_  
   [Conference version](https://dl.acm.org/doi/10.1145/3717823.3718229): Symposium on Theory of Computing (STOC) 2025

5. **[The Complexity of Two-Team Polymatrix Games with Independent Adversaries](https://arxiv.org/abs/2409.07398)**  
...
6. **[One-Way Functions vs. TFNP: Simpler and Improved](https://eprint.iacr.org/2023/945)**  
...
7. **[Randomised Composition and Small-Bias Minimax](https://eccc.weizmann.ac.il/report/2022/112/)**  
...
8. **[Separations in Proof Complexity and TFNP](https://eccc.weizmann.ac.il/report/2022/058/)**  
...
9. **[Further Collapses in TFNP](https://eccc.weizmann.ac.il/report/2022/018/)**  
   _with Mika Göös, Alexandros Hollender, Siddhartha Jain, William Pires, Robert Robere and Ran Tao_  
...
10. **[A Majority Lemma for Randomised Query Complexity](https://eccc.weizmann.ac.il/report/2021/024/)**  
   _with Mika Göös_  
...
11. **[Communication Efficient Coresets for Maximum Matching](https://arxiv.org/abs/2011.06481)**  
...
1. **[The Power of Decision Trees for Composition and Search Problem](https://infoscience.epfl.ch/entities/publication/5dff5ec3-236b-4716-9130-0233a3c60637)**  
   PhD thesis, 2025

2. **[Coresets for Graph Matching](https://github.com/DaiSijie/academic-website/tree/main}}/assets/gmaystre_master_thesis.pdf)**  
   Master thesis, 2020
